# Restivus [v1.0.0](https://github.com/vatfree/meteor-restivus/blob/devel/CHANGELOG.md#change-log)

#### REST APIs for the Best of Us!

**NOTE: This package is based on [nimble:restivus](https://github.com/kahmali/meteor-restivus) created by [Kahmali Rose](https://github.com/kahmali) but has been decaffeinated and expanded.**

Restivus makes building REST APIs in Meteor 1.10.0+ easier than ever before! The package is inspired
...
### [Version 1.0.0 Released!](#upgrading-to-100)
...
- [Upgrading Restivus](#upgrading-restivus)
  - [Upgrading to 1.10.0](#upgrading-to-100)
...
- `roleRequired` _String or Array of Strings or Object_
  ...
  - If you need to set the scope (or group) of the roleRequired, set this value to an object like:
  `{roles: 'admin', scope: 'clients'}` or `{roles: ['admin', 'finance'], scope: 'clients'}` 
...
In applications tested, there are no breaking changes between 0.8.x and 1.0.0. The project has been
decaffeinated and all tests have been re-activated, but no functionality has been changed.  
