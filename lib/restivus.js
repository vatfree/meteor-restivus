...
Restivus.prototype._collectionEndpoints = {
        ...
        return {
            put: {
                action: async function () {
                    ...
                    const entityIsUpdated = await collection.updateAsync(selector, this.bodyParams);
                    if (entityIsUpdated) {
        ...
        return {
            patch: {
                action: async function () {
                    ...
                    const entityIsUpdated = await collection.updateAsync(selector, {
                        $set: this.bodyParams
                    });
                    if (entityIsUpdated) {
        ...
        return {
            'delete': {
                action: async function () {
                    ...
                    if (await collection.removeAsync(selector)) {
                        return {
                            status: 'success',
                            data: {
    ...
    post: function (collection) {
        return {
            post: {
                action: async function () {
                    const entityId = await collection.insertAsync(this.bodyParams);
...
Restivus.prototype._userCollectionEndpoints = {
    ...
    put: function (collection) {
        return {
            put: {
                action: async function () {
                    const entityIsUpdated = await collection.updateAsync(this.urlParams.id, {
                        $set: {
    ...
    'delete': function (collection) {
        return {
            'delete': {
                action: async function () {
                    if (await collection.removeAsync(this.urlParams.id)) {
                        return {
                            status: 'success',
                            data: {
